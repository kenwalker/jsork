...
function initParks() {
    ...
    jsork.kingdom.getParks(14).then(function (data) {
...
function runReport() {
    ...
    if (wholeKingdom) {
        jsork.kingdom.getPlayers(14, jsork.filters.ACTIVE).then(function (data) {
...
function donePlayers() {
    ...
    if (olderPlayers > 0) {
        $('#oldPlayers').html("<b>There are " + olderPlayers + " player(s) who have not played in 14 months, maybe run the <a href='https://kenwalker.github.io/jsork/shouldBeRetired.html'>Should be retired</a> report?</b><br>");
    }
    $('.working').attr('hidden', true);
...
function copyToClipboard() {
    var allCSV = 'Park\tPersona\tContributing\tActive\tWaivered\tDues Paid\tDays of Attendance\tAll Attendances\r\n';
