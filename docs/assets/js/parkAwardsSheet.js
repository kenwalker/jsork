...
var totalPlayers = 0;
var timeout = 100;  // Behavior seems to be in cs instead of ms
...
function getPlayers(parkId) {
    jsork.park.getPlayers(parkId, jsork.filters.ACTIVE).then(function(result) {
        allPlayers = result;
